    ...
    public:
        ...
        public:
            ...
            uint64_t getInteger() const {
                massert(28730, "PerconaFT: wrong engine status type for getInteger", _type == UInt64);
                return _uint64;
            }
            ...
            double getDuration() const {
                ...
                msgasserted(28731, "PerconaFT: wrong engine status type for getDouble");
            }
        };
    ...
    public:
        ...
        BSONObj generateSection(OperationContext *opCtx, const BSONElement &configElement) const {
            ...
            if (configElement.isABSONObj()) {
                ...
                uassert(28732, "scale must be positive", scale > 0);
            }
