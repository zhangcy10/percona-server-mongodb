    ...
    public:
        ...
        virtual StorageEngine *create(const StorageGlobalParams &params,
            ...
            if (params.directoryperdb) {
                severe() << "PerconaFT: directoryPerDB not yet supported.  This option is incompatible with TokuFT.";
            ...
            if (tokuftGlobalOptions.engineOptions.directoryForIndexes) {
                severe() << "PerconaFT: directoryForIndexes not yet supported.  This option is incompatible with TokuFT.";
                severe() << "PerconaFT: The following server crash is intentional.";
                fassertFailedNoTrace(28630);
            }
